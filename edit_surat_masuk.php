...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if (
            ...
            $_REQUEST['nilai_tagihan'] == "" || $_REQUEST['periode_ba'] == "") { 
            ...
            $nilai_tagihan = $_REQUEST['nilai_tagihan'];
            $periode_ba = $_REQUEST['periode_ba'];
                                ...
                                if (!preg_match("/^[a-zA-Z0-9., -]*$/", $indeks)) {
                                    ...
                                    if (!preg_match("/^[0-9.-]*$/", $tgl_surat)) {
                                        ...
                                        if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)) {
                                            ...
                                            if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $nilai_tagihan)) {
                                                $_SESSION['nilai_tagihan'] = 'Form Nilai Tagihan hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), dan kurung()';
                                                echo '<script language="javascript">window.history.back();</script>';
                                            } else {
                                                if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $periode_ba)) {
                                                    $_SESSION['periode_ba'] = 'Form periode ba hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), dan kurung()';
                                                    echo '<script language="javascript">window.history.back();</script>';
                                                } else {
                                                    ...
                                                    if ($file != "") {
                                                        ...
                                                        if (in_array($eks, $ekstensi) == true) {
                                                            if ($ukuran < 2300000) {
                                                                ...
                                                                if (!empty($file)) {
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET no_agenda='$no_agenda',no_surat='$no_surat',asal_surat='$asal_surat',isi='$isi',kode='$nkode',indeks='$indeks',tgl_surat='$tgl_surat',file='$nfile',keterangan='$keterangan',nilai_tagihan='$nilai_tagihan',periode_ba='$periode_ba', id_user='$id_user' WHERE id_surat='$id_surat'");
                                                                    if ($query == true) {
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET no_agenda='$no_agenda',no_surat='$no_surat',asal_surat='$asal_surat',isi='$isi',kode='$nkode',indeks='$indeks',tgl_surat='$tgl_surat',file='$nfile',keterangan='$keterangan',
                                                                    nilai_tagihan='$nilai_tagihan',periode_ba='$periode_ba', 
                                                        ...
                                                        $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET no_agenda='$no_agenda',no_surat='$no_surat',asal_surat='$asal_surat',isi='$isi',kode='$nkode',indeks='$indeks',tgl_surat='$tgl_surat',keterangan='$keterangan',nilai_tagihan='$nilai_tagihan',periode_ba='$periode_ba', id_user='$id_user' WHERE id_surat='$id_surat'");
        ...
        $query = mysqli_query($config, "SELECT id_surat, no_agenda, no_surat, asal_surat, isi, kode, indeks, tgl_surat, file, keterangan, nilai_tagihan,Periode_ba, id_user FROM tbl_surat_masuk WHERE id_surat='$id_surat'");
        list($id_surat, $no_agenda, $no_surat, $asal_surat, $isi, $kode, $indeks, $tgl_surat, $file, $keterangan, $nilai_tagihan, $periode_ba, $id_user) = mysqli_fetch_array($query);
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input id="no_agenda" type="number" class="validate" value="<?php echo $no_agenda; ?>" name="no_agenda"
                                required>
                            <?php
                        ...
                        <div class="input-field col s6">
                            ...
                            ?>
                            <label for="indeks">Nama PIC</label>
                        </div>
                        <div class="input-field col s6">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="tgl_surat" type="text" name="tgl_surat" class="datepicker" value="<?php echo $tgl_surat; ?>"
                                required>
                            <?php
                        ...
                        <div class="input-field col s6">
                            ...
                            <textarea id="isi" class="materialize-textarea validate" name="isi"
                                required><?php echo $isi; ?></textarea>
                            <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">featured_play_list</i>
                            <input id="nilai_tagihan" type="text" class="validate" name="nilai_tagihan" required>
                            <?php
                            if (isset($_SESSION['nilai_tagihan'])) {
                                $nilai_tagihan = $_SESSION['nilai_tagihan'];
                                echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">' . $nilai_tagihan . '</div>';
                                unset($_SESSION['nilai_tagihan']);
                            }
                            ?>
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">featured_play_list</i>
                            <input id="periode_ba" type="text" class="validate" name="periode_ba" required>
                            <?php
                            if (isset($_SESSION['periode_ba'])) {
                                $periode_ba = $_SESSION['periode_ba'];
                                echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">' . $periode_ba . '</div>';
                                unset($_SESSION['periode_ba']);
                            }
                            ?>
                            <label for="periode_ba">Periode Ba</label>
                        </div>
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field">
                                ...
                                <div class="file-path-wrapper">
                                    ...
                                    ?>
                                    <small class="red-text">*Format file yang diperbolehkan *.JPG, *.PNG, *.DOC, *.DOCX,
                                        *.PDF dan
