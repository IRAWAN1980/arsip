...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if (
            $_REQUEST['no_agenda'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['asal_surat'] == "" || $_REQUEST['isi'] == "" || $_REQUEST['kode'] == "" || $_REQUEST['indeks'] == "" ||
            $_REQUEST['tgl_surat'] == "" || $_REQUEST['keterangan'] == "" || $_REQUEST['nilai_tagihan'] == "" || $_REQUEST['periode_ba'] == ""  ) {
                                                        ...
                                                        if ($file != "") {
                                                            ...
                                                            if (in_array($eks, $ekstensi) == true) {
                                                                if ($ukuran < 2500000) {
                                                                    ...
                                                                    $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,kode,indeks,tgl_surat,tgl_diterima,file,keterangan,nilai_tagihan,periode_ba, id_user)
                                                                    VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$nkode','$indeks','$tgl_surat',NOW(),'$nfile','$keterangan','$nilai_tagihan','$periode_ba','$id_user')");
                                                            ...
                                                            $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,kode,indeks,tgl_surat, tgl_diterima,file,keterangan,nilai_tagihan,periode_ba,id_user)
                                                            VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$nkode','$indeks','$tgl_surat',NOW(),'$keterangan','$nilai_tagihan','$periode_ba','$id_user')");
