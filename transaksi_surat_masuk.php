                    ...
                    <div class="z-depth-1">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <div class="col m7">
                                    <ul class="left">
                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i
                                                    class="material-icons">mail</i> Surat Masuk</a></li>
                ...
                if (isset($_REQUEST['submit'])) {
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    ...
                                    <th width="12%">Isi Ringkas<br/> File</th>
                                    <th width="10%">Asal Surat</th>
                                    <th width="10%">No. Surat<br/>Tgl Surat</th>
                                    <th width="10%">Nilai Tagihan<br/>Periode  Ba</th>
                    ...
                    if (mysqli_num_rows($query) > 0) {
                        ...
                        foreach ($query as $row) {
                            ...
                            echo '</td>
                                 ...
                                 <td>' . $row['nilai_tagihan'] . '<br/><hr/>' . $row['periode_ba'] . '</td>
                                    <td>';
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        ...
                                        <th width="10%">No. Surat<br/>Tgl Surat</th>
                                        <th width="20%">Nilai Tagihan<br/>Periode BA</th>
                    ...
                    if (mysqli_num_rows($query) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            echo '</td>
                                        <td>' . $row['asal_surat'] . '</td>
                                        <td>' . $row['no_surat'] . '<br/><hr/>' .
                                indoDate($row['tgl_surat']) . '</td>
                                        <td>' . $row['nilai_tagihan'] . '<br/><hr/>' .
                                $row['periode_ba'] . '</td>
                                        <td>';
